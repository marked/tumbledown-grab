...
allowed = function(url, parenturl)
  ...
  if string.match(url, "'+") or string.match(url, "[<>\\%*%$;%^%[%],%(%)]") or string.match(url, "//$") or string.match(url, "https?://www") or string.match(url, "https?://[a-zA-Z].facebook.com") or string.match(url, "px.srvcs.tumblr.com") or string.match(url, "https?://.+.reddit.com") or string.match(url, "https?://reddit.com") or string.match(url, "https?://twitter.com") then
    return false
  end
